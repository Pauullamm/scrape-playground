...
# Set the working directory inside the container and add it to PYTHONPATH
WORKDIR /server
...
# Start the FastAPI app using uvicorn (ensure the command uses the correct module path)
